    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('default_street_address1', models.CharField(blank=True, max_length=20, null=True)),
                ('default_street_address2', models.CharField(blank=True, max_length=20, null=True)),
