...
class CartItem(models.Model):
    ...
    def clean(self):
        """
        Ensure that either a game or a DLC is specified, but not both,
        and not neither.

        Returns:
            dict: The cleaned data.
        Raises:
            ValidationError: If neither a game nor a DLC is specified, or
            if both a game and a DLC are specified.
        """
